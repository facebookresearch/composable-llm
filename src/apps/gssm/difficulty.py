...
def gzip_loss(config: DataConfig, level: int = 9, overhead: int = 888, coef: float = 3.7) -> float:
    """
...
def estimate_gzip_losses(config: DifficultyEstimationConfig, task_id: int = 1, nb_tasks: int = 1) -> None:
    """
...
def main() -> None:
    ...
    for name, config in all_configs.items():
        ...
        # launch training
        estimate_gzip_losses(config, task_id=args.task_id, nb_tasks=args.nb_tasks)
