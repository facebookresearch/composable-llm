...
python -m src.apps.gssm.difficulty --task-id $SLURM_ARRAY_TASK_ID --nb-tasks $SLURM_ARRAY_TASK_COUNT --bsz $BSZ --n-batches $NBATCHES $PATH_TO_CODE_DIR/src/apps/gssm/configs/experiment1/$FILENAME.yaml 
